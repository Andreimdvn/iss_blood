...
class ServiceDonator(IService):
    ...
    def trimite_formular(self, formular):
        ...
        # 3. Update pe user cu valorile noi(nume, tel, locuinta)
        # 3.1 Vezi ce difera
        ...
        denumiri = ['nume', 'prenume', 'telefon']
        valori_formular = [formular.nume, formular.prenume, formular.telefon]
        ...
        if donator_info['domiciliu_localitate'] != formular.domiciliu_localitate:  #daca localitatea domiciliu difera
            ...
            id_localitate = locatii_utils.get_id_localitate(self.db, formular.domiciliu_localitate, id_judet) #cauta/ins
        ...
        if donator_info['resedinta_localitate'] != formular.resedinta_localitate:  #daca localitatea resedinta difera
            ...
            id_localitate = locatii_utils.get_id_localitate(self.db, formular.resedinta_localitate, id_judet) #cauta/ins

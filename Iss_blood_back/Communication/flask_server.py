...
class FlaskServer:
    ...
    def init_requests(self):
        ...
        self.flask_app.add_url_rule("/staff_update_formular_donare", "staff_update_fomular_donare",
                                    ...
                                    methods=["POST"])
        self.flask_app.add_url_rule("/staff_trimite_analiza", "staff_trimite_analiza", self.staff_trimite_analiza,
                                    methods=["POST"])
        self.flask_app.add_url_rule("/staff_get_stoc_curent", "staff_get_stoc_curent", self.staff_get_stoc_curent,
                                    methods=["POST"])
        self.flask_app.add_url_rule("/get_analize", "get_analize", self.get_analize, methods=["POST"])
        self.flask_app.add_url_rule("/desavarsire_cerere_medic", "desavarsire_cerere_medic", self.trimite_pungi,
                                    methods=["POST"])
    ...
    def get_messages_for_user(self):
        ...
        user = self.request_data["user"]
        self.logger.debug("Sending all messages for user [%s]!" % user)

        status, mesaj = self.controller.get_messages_for_user(user)
